...
from PythonScripts.data_preparation import LoadData, H5pyToTensor, CreateDataLoaderV2, CreateDataLoadersWithMultiDatasetV2, MaskingData, TransformMaskDataV2
from PythonScripts.data_preparation import MaskingDataFake, FastFourierTransform      # create fake mask data, for comparison
from PythonScripts.embedding import PatchEmbedding, ProjectionModule
from PythonScripts.transformer import SeismicTransformerV2
...
traindata_mask_list_1D = TransformMaskDataV2(mask_data=traindata_mask_list,
                                           num_of_patch=Num_Of_Patch,
                                           patch_size=PATCH_SIZE)
validationdata_mask_list_1D = TransformMaskDataV2(mask_data=validationdata_mask_list,
                                           num_of_patch=Num_Of_Patch,
                                           patch_size=PATCH_SIZE)
testdata_mask_list_1D = TransformMaskDataV2(mask_data=testdata_mask_list,
                                           num_of_patch=Num_Of_Patch,
                                           patch_size=PATCH_SIZE)
...
train_dataloader, validation_dataloader = CreateDataLoadersWithMultiDatasetV2(data_list=dataset_list,
...
SeT = SeismicTransformerV2(len_of_gm=GM_Length,
                        patch_size=PATCH_SIZE,
...
num_training_steps = 1000          # 10k steps
